...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev.hctorpedo.ru/leaders/
Call log:
  - navigating to "https://dev.hctorpedo.ru/leaders/", waiting until "domcontentloaded"
