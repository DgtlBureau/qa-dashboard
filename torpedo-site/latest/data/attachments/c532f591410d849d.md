...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev.hctorpedo.ru/season/tournament_tables/
Call log:
  - navigating to "https://dev.hctorpedo.ru/season/tournament_tables/", waiting until "domcontentloaded"
