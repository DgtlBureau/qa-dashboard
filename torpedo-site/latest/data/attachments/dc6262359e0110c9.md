...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev.hctorpedo.ru/fan_zone/
Call log:
  - navigating to "https://dev.hctorpedo.ru/fan_zone/", waiting until "domcontentloaded"
