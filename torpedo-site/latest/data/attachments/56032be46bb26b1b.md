...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev.hctorpedo.ru/teamroster/
Call log:
  - navigating to "https://dev.hctorpedo.ru/teamroster/", waiting until "domcontentloaded"
