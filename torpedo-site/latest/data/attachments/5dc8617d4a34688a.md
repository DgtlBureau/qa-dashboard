...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev.hctorpedo.ru/season/statistics/
Call log:
  - navigating to "https://dev.hctorpedo.ru/season/statistics/", waiting until "domcontentloaded"
