...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev.hctorpedo.ru/history/
Call log:
  - navigating to "https://dev.hctorpedo.ru/history/", waiting until "domcontentloaded"
