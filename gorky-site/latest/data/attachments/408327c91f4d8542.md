...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/loyalty/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/loyalty/", waiting until "domcontentloaded"
