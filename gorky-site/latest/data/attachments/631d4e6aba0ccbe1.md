...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/season/statistics/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/season/statistics/", waiting until "domcontentloaded"
