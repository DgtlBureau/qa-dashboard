...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/online/broadcasts/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/online/broadcasts/", waiting until "domcontentloaded"
