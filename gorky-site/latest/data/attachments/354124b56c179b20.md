...
- Name: 14-khl-sync.spec.js >> API: список игроков ≥25 @critical @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:9:5
...
Call log:
  - → GET https://dev-gorky.hctorpedo.ru/api/v1/website/players
