...
- Name: 14-khl-sync.spec.js >> API: статистика игроков доступна @major @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:69:5
...
Call log:
  - → GET https://dev-gorky.hctorpedo.ru/api/v1/website/player-stats
