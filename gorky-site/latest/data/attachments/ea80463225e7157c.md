...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/tickets/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/tickets/", waiting until "domcontentloaded"
