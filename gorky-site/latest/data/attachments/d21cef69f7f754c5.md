...
- Name: 14-khl-sync.spec.js >> API: турнирная таблица содержит Торпедо @critical @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:21:5

# Error details

```
Error: apiRequestContext.get: getaddrinfo ENOTFOUND dev-gorky.hctorpedo.ru
Call log:
  - → GET https://dev-gorky.hctorpedo.ru/api/v1/website/standings
