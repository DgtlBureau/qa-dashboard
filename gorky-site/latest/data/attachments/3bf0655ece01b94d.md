...
- Name: 02-content.spec.js >> Календарь — ячейки содержат текст команд @major
- Location: tests/e2e/02-content.spec.js:87:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/season/calendar/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/season/calendar/", waiting until "domcontentloaded"
