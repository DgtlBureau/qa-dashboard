...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/photogallery/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/photogallery/", waiting until "domcontentloaded"
