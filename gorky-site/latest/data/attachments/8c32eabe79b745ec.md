...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/photogallery/wallpaper/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/photogallery/wallpaper/", waiting until "domcontentloaded"
