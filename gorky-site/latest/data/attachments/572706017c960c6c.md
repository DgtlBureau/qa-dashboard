...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/coaches/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/coaches/", waiting until "domcontentloaded"
