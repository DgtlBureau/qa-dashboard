...
- Name: 14-khl-sync.spec.js >> API: следующий матч — дата актуальна @critical @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:30:5
...
Call log:
  - → GET https://dev-gorky.hctorpedo.ru/api/v1/khl-next-match
