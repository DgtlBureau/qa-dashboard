...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/legends/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/legends/", waiting until "domcontentloaded"
