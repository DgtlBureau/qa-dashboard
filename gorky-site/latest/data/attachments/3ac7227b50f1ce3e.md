...
- Name: 14-khl-sync.spec.js >> API: матчи сезона не пустые @major @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:59:5
...
Call log:
  - → GET https://dev-gorky.hctorpedo.ru/api/v1/khl-matches
