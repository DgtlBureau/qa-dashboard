...
- Name: 14-khl-sync.spec.js >> API: тренерский штаб ≥5 @major @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:121:5
...
Call log:
  - → GET https://dev-gorky.hctorpedo.ru/api/v1/website/staff
