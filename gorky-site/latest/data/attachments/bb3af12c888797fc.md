...
- Name: 14-khl-sync.spec.js >> Новости: количество на dev ≈ prod (отклонение ≤5%) @major @khl-sync
- Location: tests/e2e/14-khl-sync.spec.js:88:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-gorky.hctorpedo.ru/news/
Call log:
  - navigating to "https://dev-gorky.hctorpedo.ru/news/", waiting until "domcontentloaded"
