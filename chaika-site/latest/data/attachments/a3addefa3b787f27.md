...
- Name: 02-content.spec.js >> Фотогалерея — есть хотя бы 1 альбом @major
- Location: tests/e2e/02-content.spec.js:79:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/photogallery/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/photogallery/", waiting until "domcontentloaded"
