...
- Name: 03-functional.spec.js >> Страница /tickets/ открывается и содержит контент @critical
- Location: tests/e2e/03-functional.spec.js:6:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/tickets/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/tickets/", waiting until "domcontentloaded"
