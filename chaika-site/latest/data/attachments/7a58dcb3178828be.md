...
- Name: 11-ssl-meta.spec.js >> Сайт доступен по HTTPS @critical
- Location: tests/e2e/11-ssl-meta.spec.js:6:5

# Error details

```
Error: HTTPS недоступен: https://dev-chaika.hctorpedo.ru
