...
- Name: 01-availability.spec.js >> История /history/ отвечает 200 @critical
- Location: tests/e2e/01-availability.spec.js:8:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/history/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/history/", waiting until "domcontentloaded"
