...
- Name: 19-match-details.spec.js >> Блок «Предыдущий матч» — ссылка ведёт на свой домен, не на prod @major
- Location: tests/e2e/19-match-details.spec.js:25:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/", waiting until "domcontentloaded"
