...
- Name: 04-visual.spec.js >> Изображения загружены на /teamroster/ @minor
- Location: tests/e2e/04-visual.spec.js:47:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/teamroster/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/teamroster/", waiting until "domcontentloaded"
