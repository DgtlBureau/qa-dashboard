...
- Name: 04-visual.spec.js >> Изображения загружены на /coaches/ @minor
- Location: tests/e2e/04-visual.spec.js:55:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/coaches/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/coaches/", waiting until "domcontentloaded"
