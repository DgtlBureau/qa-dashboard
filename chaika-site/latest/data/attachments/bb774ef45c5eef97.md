...
- Name: 06-fonts.spec.js >> /contacts/ — текст использует Play @minor
- Location: tests/e2e/06-fonts.spec.js:32:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/contacts/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/contacts/", waiting until "domcontentloaded"
