...
- Name: 01-availability.spec.js >> Школа /school/ отвечает 200 @critical
- Location: tests/e2e/01-availability.spec.js:8:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/school/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/school/", waiting until "domcontentloaded"
