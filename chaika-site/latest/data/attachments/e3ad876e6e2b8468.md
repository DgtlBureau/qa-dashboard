...
- Name: 02-content.spec.js >> Статистика — таблица бомбардиров не пустая @major
- Location: tests/e2e/02-content.spec.js:63:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/season/statistics/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/season/statistics/", waiting until "domcontentloaded"
