...
- Name: 01-availability.spec.js >> Легенды /legends/ отвечает 200 @critical
- Location: tests/e2e/01-availability.spec.js:8:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/legends/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/legends/", waiting until "domcontentloaded"
