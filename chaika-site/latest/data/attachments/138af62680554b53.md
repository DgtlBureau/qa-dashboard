...
- Name: 01-availability.spec.js >> Трансляции /online/broadcasts/ отвечает 200 @critical
- Location: tests/e2e/01-availability.spec.js:8:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/online/broadcasts/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/online/broadcasts/", waiting until "domcontentloaded"
