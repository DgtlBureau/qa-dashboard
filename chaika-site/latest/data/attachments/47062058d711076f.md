...
- Name: 18-tickets.spec.js >> /tickets/season/ — страница доступна (не 403) @major
- Location: tests/e2e/18-tickets.spec.js:30:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/tickets/season/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/tickets/season/", waiting until "domcontentloaded"
