...
- Name: 16-photo-freshness.spec.js >> Обои /photogallery/wallpaper/ — страница доступна (не 403) @major
- Location: tests/e2e/16-photo-freshness.spec.js:25:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/photogallery/wallpaper/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/photogallery/wallpaper/", waiting until "domcontentloaded"
