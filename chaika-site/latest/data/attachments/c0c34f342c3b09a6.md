...
- Name: 02-content.spec.js >> Руководство — есть хотя бы 2 человека @major
- Location: tests/e2e/02-content.spec.js:49:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/leaders/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/leaders/", waiting until "domcontentloaded"
