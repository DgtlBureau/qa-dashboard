...
- Name: 02-content.spec.js >> Турнирная таблица — содержит Торпедо @major
- Location: tests/e2e/02-content.spec.js:56:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/season/tournament_tables/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/season/tournament_tables/", waiting until "domcontentloaded"
