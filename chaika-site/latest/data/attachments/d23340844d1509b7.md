...
- Name: 15-video-categories.spec.js >> Видео: количество на dev ≈ prod (отклонение ≤10%) @major
- Location: tests/e2e/15-video-categories.spec.js:55:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/video/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/video/", waiting until "domcontentloaded"
