...
- Name: 02-content.spec.js >> Персонал — есть хотя бы 5 человек @major
- Location: tests/e2e/02-content.spec.js:42:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://dev-chaika.hctorpedo.ru/staffs/
Call log:
  - navigating to "https://dev-chaika.hctorpedo.ru/staffs/", waiting until "domcontentloaded"
