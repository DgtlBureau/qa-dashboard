      ...
      - generic [ref=e106]:
        ...
        - generic [ref=e108]:
          - generic [ref=e109]:
            ...
            - text: Торпедо
          - generic [ref=e111]:
            - generic [ref=e112]: 14 августа, пт, 16:00
            - text: КРК Нагорный
          - generic [ref=e113]:
            - img "Динамо" [ref=e114]
            - text: Динамо
      ...
      - generic [ref=e139]:
        ...
        - generic [ref=e145]:
          ...
          - link "Пользовательское соглашение" [ref=e147] [cursor=pointer]:
            - /url: /terms
  - generic [ref=e148]:
    - button "Закрыть" [ref=e149] [cursor=pointer]
    - link "Абонементы на сезон уже в продаже" [ref=e150] [cursor=pointer]:
      - /url: https://shop.hctorpedo.ru/
      - img "Абонементы на сезон уже в продаже" [ref=e152]
      - generic [ref=e153]:
        - text: Купить абонемент
        - img [ref=e154]
  - dialog "Уведомление об использовании файлов cookie" [ref=e156]:
    - generic [ref=e157]:
      - paragraph [ref=e158]:
        - text: Мы используем файлы cookie для улучшения работы сайта. Продолжая пользоваться сайтом, вы соглашаетесь с
        - link "Политикой конфиденциальности" [ref=e159] [cursor=pointer]:
          - /url: /privacy
        - text: .
      - generic [ref=e160]:
        - button "Принять" [ref=e161] [cursor=pointer]
        - button "Отказаться" [ref=e162] [cursor=pointer]
```